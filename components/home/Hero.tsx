      ...
      <div className="container-x relative flex min-h-[92vh] flex-col justify-end pb-8 pt-32 lg:min-h-screen lg:pb-10">
        <div className="max-w-3xl">
          ...
          >
            ...
            carefully selected land across Zanzibar. SILA provides trusted support
            from your first enquiry to the completion of your property journey.
          </motion.p>
          ...
          >
            ...
            <Link href="/investment-advisory" className="btn-ghost-light">
