...
-- ---------------------------------------------------------------------------
-- Storage — admin-managed listing images (public bucket)
--
-- Properties / projects / plots images uploaded from the admin dashboard.
-- Publicly readable (so the site can display them); uploads happen via signed
-- upload URLs generated by the service role in admin-guarded server actions.
-- ---------------------------------------------------------------------------
insert into storage.buckets (id, name, public)
